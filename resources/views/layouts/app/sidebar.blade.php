            ...
            <flux:sidebar.nav>
                ...
                @if (auth()->user()?->isAdmin())
                    <flux:sidebar.group :heading="__('Admin')" class="grid">
                        ...
                        <flux:sidebar.item icon="users" :href="route('admin.suppliers')" :current="request()->routeIs('admin.suppliers')" wire:navigate>
                            {{ __('Suppliers') }}
                        </flux:sidebar.item>
                        ...
                        <flux:sidebar.item icon="globe-alt" :href="route('admin.inquiries')" :current="request()->routeIs('admin.inquiries')" wire:navigate>
                            {{ __('Bulk Inquiries') }}
                        </flux:sidebar.item>
                    </flux:sidebar.group>
                @endif
